...
{
    draw_single(430, 0, 2);
    text_show_font_index(480/2-48, 5, 0, 48, 0, BLACK);//��������
    ...
    text_show_string(120, 65 + 12, 32*4, 32, "��  ��:", 32, 0, BLACK);
    text_show_string(480/2, 65, 120, 48, "0.00", 48, 0, BLACK);
    text_show_string(360, 65 + 12, 120, 32, "Ԫ\/g", 32, 0, BLACK);

    text_show_string(120, (65 + 48 * 1 + 12), 32*4, 32, "��  ��:", 32, 0, BLACK);
    text_show_string(480/2, (65 + 48 * 1), 100, 48, "0.00", 48, 0, BLACK);
    text_show_string(360, (65 + 48 * 1 + 12), 120, 32, "��(g)", 32, 0, BLACK);

    text_show_string(120, (65 + 48 * 2 + 12), 32*4, 32, "��  ��:", 32, 0, BLACK);
    text_show_string(480/2, (65 + 48 * 2), 100, 48, "0.00", 48, 0, BLACK);
    text_show_string(360, (65 + 48 * 2 + 12), 120, 32, "Ԫ", 32, 0, BLACK);

    text_show_string(120 - 32, (65 + 48 * 3 + 12), 32*5, 32, "�����ܶ�:", 32, 0, GREEN);
    text_show_string(480/2, (65 + 48 * 3), 100, 48, "0.00", 48, 0, GREEN);
    text_show_string(360, (65 + 48 * 3 + 12), 120, 32, "Ԫ", 32, 0, GREEN);

    text_show_string(480/2/2 - 64, 275, 32*4, 32, "��ӭʹ��", 32, 0, RED);// zuoxia
